...
qst.l10n.paysystemadd = {
	...
	'qiwi_itm_2': {
		en: 'During registration set a name of your shop. You can set qstoq.ru as an address.',
		ru: 'При регистрации укажите название вашего магазина. В качестве сайта можете указать qstoq.ru.'
	},
