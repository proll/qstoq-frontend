qst.AddPageView = qst.PageView.extend({
	el: "body",

	addUpload: function (upload_model) {
		this.$el.find(".add-page-row").html(upload_model.view.$el);
	},

	render: function(in_popup){
		this.popup_view = new qst.PopupView({class: "add-popup"});
